...
# This piece of code is useful for generating a Digraph with N nodes;
# For our current purposes and with our current digraph, this function is DEPRECATED.
...
# This piece of code is useful for a simple Network with N nodes;
# For our current purposes and with our current digraph, this function is DEPRECATED.
...
def identify_day_beginnings(time_grid):
    """
...
def capture_day_elements(time_grid, day_beginnings):
    """
    ...
    return np.array(day_elements)

def find_array_index(arrays, value):
    """
    Find the index of the array containing the given value.
    ...
    indices = np.flatnonzero(arrays_flat == value)
...
class FluxModel:
    ...
    def __init__(self, travel_rates, T, save_path):
        ...
        self.day_beginnings = identify_day_beginnings(self.T)
        self.day_elements = capture_day_elements(self.T, self.day_beginnings)
