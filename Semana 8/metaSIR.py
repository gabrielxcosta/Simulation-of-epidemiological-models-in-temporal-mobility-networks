...
def find_filled_elements_matrix_columns(matrix):
    ...
    Returns:
        tuple: A tuple containing two lists:
            1. A list of tuples, where each tuple represents the coordinates (row, column) of a filled element.
            2. A list of integers, where each integer represents the count of filled elements in the corresponding column.
    """
    filled_elements = []
...
def find_filled_elements_matrix_rows(matrix):
    ...
    Returns:
        tuple: A tuple containing two lists:
            1. A list of tuples, where each tuple represents the coordinates (row, column) of a filled/non-zero element.
            2. A list of integers, where each integer represents the count of filled elements in the corresponding row.
    """
    filled_elements = []
    filled_elements_quantity = []
...
def find_filled_elements(travel_rates):
    ...
    dict: A dictionary containing the following keys and corresponding values:
        - 'coords_inflow_filled_elements' (tuple of lists with tuples): A tuple containing the filled elements for inflow matrices.
            Each array within the tuple contains pairs of indices (i, j) where travel_rates[t, i, j] is filled,
            and i is not equal to j (indices not on the main diagonal) for each matrix in the tuple.
        - 'coords_outflow_filled_elements' (tuple of lists with tuples): A tuple containing the filled elements for outflow matrices.
            Each array within the tuple contains pairs of indices (i, j) where travel_rates[t, i, j] is filled,
            and i is not equal to j (indices not on the main diagonal) for each matrix in the tuple.
...
def normalize_travel_rates(travel_rates):
    ...
    # Find filled elements that are not on the main diagonal
