...
def temporal_verifier(arrays, value):
    """
...
class FluxModel:
    ...
    def _serial_ode(self, N, t):
        ...
        """
        outflow = self.outflow_rates[temporal_verifier(self.day_elements, t)]
        inflow = self.inflow_rates[temporal_verifier(self.day_elements, t)]
...
class SIRModel(FluxModel):
    ...
    travel_rates : tuple(numpy.ndarray, numpy.ndarray)
            ...
            to subpopulation i. The diagonal of both numpy.ndarrays should be equal to 0.0.
    T : numpy.ndarray
        The final time points of the simulation.
    save_path : str
        The path to save the simulation results.
    beta : numpy.ndarray
